...
public class ThermostatDevice extends IDevice {

    public ThermostatDevice(String ipv4, int port, String mac, String name, String description, DeviceType deviceType) {
