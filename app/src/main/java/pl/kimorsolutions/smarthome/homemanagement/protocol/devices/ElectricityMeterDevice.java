...
import pl.kimorsolutions.smarthome.homemanagement.ui.devices.DevicesViewModel;

public class ElectricityMeterDevice extends IDevice {

    public ElectricityMeterDevice(String ipv4, int port, String mac, String name, String description, DeviceType deviceType) {
