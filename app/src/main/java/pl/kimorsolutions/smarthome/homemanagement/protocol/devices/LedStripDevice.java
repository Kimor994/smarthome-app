...
public class LedStripDevice extends IDevice {

    public LedStripDevice(String ipv4, int port, String mac, String name, String description, DeviceType deviceType) {
        super(ipv4, port, mac, name, description, deviceType);
    }

    @Override
    public DeviceType getType() {
        return DeviceType.LED_STRIP;
    }
